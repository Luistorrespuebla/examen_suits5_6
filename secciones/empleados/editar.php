...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
          <label for="segundonombre" class="form-label">Segundo apellido:</label>
          <input type="text"
          value="<?php echo $segundoapellido;?>"
            class="form-control" name="segundonombre" id="segundonombre" aria-describedby="helpId" placeholder="Segundo apellido">
        </div>
