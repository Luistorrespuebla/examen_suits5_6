        ...
        <table class="table" id="tabla_id">
            ...
            <?php foreach ($lista_tbl_empleados as $registro) { ?>
                <tr class="">
                    ...
                    <td>
                        <img width="50" src="<?php echo $registro['foto']; ?>" class="img-fluid rounded-top" alt="" />
                    </td>
                    <td>
                    ...
                    <td>
                        <a class="btn btn-info" href="contrato.php?txtID=<?php echo $registro['id'];?>" role="button">Contrato</a>    
